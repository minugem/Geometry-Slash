...
bool XboxController::Initialise(int controllerIndex)
{
...
ButtonState XboxController::GetButtonState(SDL_GameControllerButton button)
{
...
const Vector2& XboxController::GetRightStick() const
{
	return m_rightStick;
}

...
bool SceneBouncingBalls::Initialise(Renderer& renderer)
{
	for (int k = 0; k < 100; ++k)
	{
		m_pBalls[k] = new Ball(); 
...
void SceneBouncingBalls::Process(float deltaTime)
{
...
void SceneBouncingBalls::SyncCurrentScene(int* m_iCurrentScene, std::vector<Scene*>* m_scenes)
{
